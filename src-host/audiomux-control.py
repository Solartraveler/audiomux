...
if (backendUsblib1 is None):
	...
	if (backendUsblib1 is None):
		...
		if (os.name == 'nt'):
			...
			print('You can get libusb-1.0.dll by pip install libusb1')
			print('Or download from https://libusb.info/ -> within the .7z from the folder VS2019\\MS64\\dll')
		else:
			print('Try sudo apt install libusb-1.0-0 or any proper other command depending on your distribution')
		sys.exit(3)
